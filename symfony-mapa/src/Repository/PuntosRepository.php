...
/**
 * @extends ServiceEntityRepository<Puntos>
 *
...
class PuntosRepository extends ServiceEntityRepository
{
    ...
    public function save(Puntos $entity, bool $flush = false): void
    {
    ...
    public function remove(Puntos $entity, bool $flush = false): void
    {
